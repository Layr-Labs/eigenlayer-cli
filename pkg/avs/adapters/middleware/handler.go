...
import (
	...
	contractAVSDirectory "github.com/Layr-Labs/eigensdk-go/contracts/bindings/AVSDirectory"
...
func (m *OperatorRegistrationHandler) getRegistrationParams(
...
) (*contractRegistryCoordinator.IBLSApkRegistryTypesPubkeyRegistrationParams, error) {
	...
	params := contractRegistryCoordinator.IBLSApkRegistryTypesPubkeyRegistrationParams{
...
func (m *OperatorRegistrationHandler) getRegistrationSignature(
	...
	avsDirectory *contractAVSDirectory.ContractAVSDirectory,
...
func (m *OperatorRegistrationHandler) churn(
	...
	blsKeyPair *bn254.KeyPair,
) ([]contractRegistryCoordinator.ISlashingRegistryCoordinatorTypesOperatorKickParam, contractRegistryCoordinator.ISignatureUtilsSignatureWithSaltAndExpiry, error) {
	...
	operatorsToChurn := make(
		[]contractRegistryCoordinator.ISlashingRegistryCoordinatorTypesOperatorKickParam,
	...
	for i := range churnReply.OperatorsToChurn {
		...
		operatorsToChurn[i] = contractRegistryCoordinator.ISlashingRegistryCoordinatorTypesOperatorKickParam{
...
func (m *OperatorRegistrationHandler) Register(
	...
	avsDirectory, err := contractAVSDirectory.NewContractAVSDirectory(avsDirectoryAddr, txMgr.Client)
	if err != nil {
...
func (m *OperatorRegistrationHandler) Deregister(
	...
	tx, receipt, err := txMgr.CallAndWaitForReceipt(ctx, func(opts *bind.TransactOpts) (*types.Transaction, error) {
		op, err2 := registryCoordinator.DeregisterOperator0(opts, quorumIDsToQuorumNumbers(params.QuorumIDs))
		if err2 != nil {
